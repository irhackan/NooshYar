            ...
            when (step) {
                0 -> {
                    ...
                    Slider(
                        ...
                        onValueChange = {
                            viewModel.updateWakeTime(it.toInt())
                        },
                    ...
                    Slider(
                        ...
                        onValueChange = {
                            viewModel.updateSleepTime(it.toInt())
                        },
                ...
                1 -> {
                    ...
                    LevelSelector(
                        ...
                        onSelect = {
                            viewModel.updateWorkPressure(it)
                        }
                    )
                    ...
                    LevelSelector(
                        ...
                        onSelect = {
                            viewModel.updateCaffeineSensitivity(it)
                        }
                    )
                }
                    ...
                    UserGoal.entries.forEach { goal ->
                        ...
                        Row(
                            modifier = Modifier
                                .fillMaxWidth()
                                .selectable(
                                    selected = goal in profile.selectedGoals,
                                    onClick = {
                            ...
                            Checkbox(
                                checked = goal in profile.selectedGoals,
                                onCheckedChange = {
                                    viewModel.toggleGoal(goal)
                                }
                            )
                ...
                NooshCard {
                    ...
                    Text(
                        text = "${stringResource(R.string.water_goal)}: ${
                            currentProfile.waterDailyGoal
                        } ml"
                    )

                    Text(
                        text = "${stringResource(R.string.caffeine_limit)}: ${
                            currentProfile.caffeineDailyLimit
                        } mg"
                    )
